# <img src="https://github.com/PhantomBotRU/PhantomBotRU/blob/nightly/web/panel/img/logo.png" width="84px" align="left" alt="PhantomBotRU"/> PhantomBotRU<br>русская локализация [PhantomBot](https://phantom.bot)

## Текущая версия
На данный момент локализация PhantomBotRU совместима с оригинальной ночной сборкой PhantomBot-3.0.0-NB-20190516.
