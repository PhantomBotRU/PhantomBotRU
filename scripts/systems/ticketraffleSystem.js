...
(function() {
    var cost = 0,
        ...
        followers = false,
        raffleStatus = false,
        msgToggle = $.getSetIniDbBoolean('settings', 'tRaffleMSGToggle', true),
        raffleMessage = $.getSetIniDbString('settings', 'traffleMessage', 'Проводится лотерея, для участия наберите «!tickets (amount)» (участников сейчас: (entries))'),
