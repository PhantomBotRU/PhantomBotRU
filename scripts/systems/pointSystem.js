...
(function() {
    var pointsTimedGain = $.getSetIniDbBoolean('pointSettings', 'pointsTimedGain', true),
        ...
        onlinePayoutInterval = $.getSetIniDbNumber('pointSettings', 'onlinePayoutInterval', 5),
        offlinePayoutInterval = $.getSetIniDbNumber('pointSettings', 'offlinePayoutInterval', 30),
        activeBonus = $.getSetIniDbNumber('pointSettings', 'activeBonus', 1),
        lastPayout = 0,
        penaltys = [],
        pointsBonus = false,
        pointsBonusAmount = 0,
        pointNameSingle = $.getSetIniDbString('pointSettings', 'pointNameSingle', 'поинт'),
        pointNameMultiple = $.getSetIniDbString('pointSettings', 'pointNameMultiple', 'поинтов'),
        pointsMessage = $.getSetIniDbString('pointSettings', 'pointsMessage', '(rank) (userprefix) на вашем счёте (pointsstring)'),
        userCache = {};
