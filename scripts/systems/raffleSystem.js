...
(function() {
    var entries = [],
        ...
        usePoints = true,
        status = false,
        sendMessages = $.getSetIniDbBoolean('raffleSettings', 'raffleMSGToggle', true),
        ...
        raffleMessage = $.getSetIniDbString('raffleSettings', 'raffleMessage', 'Проводится розыгрыш, для участия наберите «(keyword)» (участников сейчас: (entries))'),
