...
(function() {
    ...
    $.bind('initReady', function() {
        $.registerChatCommand('./commands/deathctrCommand.js', 'wins', 7);

        $.registerChatSubcommand('wins', 'reset', 2);
        $.registerChatSubcommand('wins', 'set', 2);
        $.registerChatSubcommand('wins', 'add', 2);
        $.registerChatSubcommand('wins', 'incr', 2);
        $.registerChatSubcommand('wins', '+', 2);
        $.registerChatSubcommand('wins', 'sub', 2);
        $.registerChatSubcommand('wins', 'decr', 2);
        $.registerChatSubcommand('wins', '-', 2);
