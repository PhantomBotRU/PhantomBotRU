 ...
 */
(function() {
    var subMessage = $.getSetIniDbString('discordSettings', 'subMessage', 'от [(name)](https://twitch.tv/(name))'),
        primeMessage = $.getSetIniDbString('discordSettings', 'primeMessage', 'от [(name)](https://twitch.tv/(name))'),
        resubMessage = $.getSetIniDbString('discordSettings', 'resubMessage', 'от [(name)](https://twitch.tv/(name)) в (months)-й раз подряд'),
        giftsubMessage = $.getSetIniDbString('discordSettings', 'giftsubMessage', '[(recipient)](https://twitch.tv/(recipient)) от [(name)](https://twitch.tv/(name))'),
    ...
    $.bind('webPanelSocketUpdate', function(event) {
        if (event.getScript().equalsIgnoreCase('./discord/handlers/subscribeHandler.js')) {
            subMessage = $.getIniDbString('discordSettings', 'subMessage', 'от [(name)](https://twitch.tv/(name))');
            primeMessage = $.getIniDbString('discordSettings', 'primeMessage', 'от [(name)](https://twitch.tv/(name))');
            resubMessage = $.getIniDbString('discordSettings', 'resubMessage', 'от [(name)](https://twitch.tv/(name)) в (months)-й раз подряд');
            giftsubMessage = $.getSetIniDbString('discordSettings', 'giftsubMessage', '[(recipient)](https://twitch.tv/(recipient)) от [(name)](https://twitch.tv/(name))');
