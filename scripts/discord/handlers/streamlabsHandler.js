...
(function() {
    var toggle = $.getSetIniDbBoolean('discordSettings', 'streamlabsToggle', false),
        message = $.getSetIniDbString('discordSettings', 'streamlabsMessage', '(amount) (currency) от (name)'),
    ...
    $.bind('webPanelSocketUpdate', function(event) {
        if (event.getScript().equalsIgnoreCase('./discord/handlers/streamlabsHandler.js')) {
            ...
            message = $.getIniDbString('discordSettings', 'streamlabsMessage', '(amount) (currency) от (name)');
