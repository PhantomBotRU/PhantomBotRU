...
(function() {
    var toggle = $.getSetIniDbBoolean('discordSettings', 'bitsToggle', false),
        message = $.getSetIniDbString('discordSettings', 'bitsMessage', '(amount) шт. от [(name)](https://twitch.tv/(name))'),
    ...
    $.bind('webPanelSocketUpdate', function(event) {
        if (event.getScript().equalsIgnoreCase('./discord/handlers/bitsHandler.js')) {
            ...
            message = $.getIniDbString('discordSettings', 'bitsMessage', '(amount) шт. от [(name)](https://twitch.tv/(name))');
