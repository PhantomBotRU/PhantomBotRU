...
(function() {
    var toggle = $.getSetIniDbBoolean('discordSettings', 'tipeeestreamToggle', false),
        message = $.getSetIniDbString('discordSettings', 'tipeeestreamMessage', '(amount) (currency) от (name)'),
    ...
    $.bind('webPanelSocketUpdate', function(event) {
        if (event.getScript().equalsIgnoreCase('./discord/handlers/tipeeeStreamHandler.js')) {
            ...
            message = $.getIniDbString('discordSettings', 'tipeeestreamMessage', '(amount) (currency) от (name)');
