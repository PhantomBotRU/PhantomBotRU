...
(function() {
    var toggle = $.getSetIniDbBoolean('discordSettings', 'followToggle', false),
        message = $.getSetIniDbString('discordSettings', 'followMessage', 'от [(name)](https://twitch.tv/(name))'),
    ...
    $.bind('webPanelSocketUpdate', function(event) {
        if (event.getScript().equalsIgnoreCase('./discord/handlers/followHandler.js')) {
            ...
            message = $.getIniDbString('discordSettings', 'followMessage', 'от [(name)](https://twitch.tv/(name))');
