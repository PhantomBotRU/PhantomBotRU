 ...
 *  - To register command to our command list https://phantom.bot/commands/discord please add a comment starting with @discordcommandpath before the command info.
