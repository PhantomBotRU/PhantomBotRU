...
(function() {
    ...
    function calculate(channel, username, mention, twitchName) {
        ...
        if (e1 == e2 && e2 == e3) {
            ...
            $.discord.say(channel, message + $.lang.get('slotmachine.result.win', (e1 == e2 ? $.getPointsString(Math.floor(rewards[e1] * 0.3)) : $.getPointsString(Math.floor(rewards[e3] * 0.3))) + '\r\n') + $.gameMessages.getWin(username, 'slot'));
