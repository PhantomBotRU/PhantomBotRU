(function() {
    var joinToggle = $.getSetIniDbBoolean('discordSettings', 'joinToggle', false),
        ...
        joinMessage = $.getSetIniDbString('discordSettings', 'joinMessage', '(name) пожаловал(а) в Discord'),
        partMessage = $.getSetIniDbString('discordSettings', 'partMessage', '(name) покинул(а) Discord'),
    ...
    $.bind('webPanelSocketUpdate', function(event) {
        if (event.getScript().equalsIgnoreCase('./discord/systems/greetingsSystem.js')) {
            ...
            joinMessage = $.getIniDbString('discordSettings', 'joinMessage', '(name) пожаловал(а) на сервер');
            partMessage = $.getIniDbString('discordSettings', 'partMessage', '(name) покинул(а) сервер');
