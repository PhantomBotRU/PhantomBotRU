...
(function() {
    var message = $.getSetIniDbString('streamElementsHandler', 'message', $.lang.get('streamElements.donation.new')),
        toggle = $.getSetIniDbBoolean('streamElementsHandler', 'toggle', true),
        reward = $.getSetIniDbFloat('streamElementsHandler', 'reward', 5),
        group = $.getSetIniDbBoolean('streamElementsHandler', 'group', true),
