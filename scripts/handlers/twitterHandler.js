...
(function() {
    ...
    $.getSetIniDbString('twitter', 'message_online', 'Начало стрима на канале (twitchurl)');
    $.getSetIniDbString('twitter', 'message_gamechange', 'Смена игры на (game) на канале (twitchurl)');
    $.getSetIniDbString('twitter', 'message_update', 'Стрим длится уже (uptime) на канале (twitchurl)');
    ...
    $.getSetIniDbBoolean('twitter', 'poll_retweets', true);
    $.getSetIniDbBoolean('twitter', 'poll_hometimeline', false);
    $.getSetIniDbBoolean('twitter', 'poll_usertimeline', true);
    $.getSetIniDbBoolean('twitter', 'post_online', true);
    $.getSetIniDbBoolean('twitter', 'post_gamechange', true);
    $.getSetIniDbBoolean('twitter', 'post_update', false);
    $.getSetIniDbBoolean('twitter', 'reward_toggle', true);
    $.getSetIniDbBoolean('twitter', 'reward_announce', true);
        ...
        if (command.equalsIgnoreCase('twitter')) {
            ...
            if (commandArg.equalsIgnoreCase('lastmention')) {
                if ($.getIniDbBoolean('twitter', 'poll_mentions', false)) {
                    $.say($.whisperPrefix(sender) + $.lang.get('twitter.lastmention', $.getIniDbString('twitter', 'last_mentions', 'не найдено')));
                    return;
                }
            ...
            if (commandArg.equalsIgnoreCase('lastretweet')) {
                if ($.getIniDbBoolean('twitter', 'poll_retweets', false)) {
                    $.say($.whisperPrefix(sender) + $.lang.get('twitter.lastretweet', $.getIniDbString('twitter', 'last_retweets', 'не найден')));
                    return;
                }
