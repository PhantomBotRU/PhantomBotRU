 ...
 */
(function() {
    var hostReward = $.getSetIniDbNumber('settings', 'hostReward', 100),
        autoHostReward = $.getSetIniDbNumber('settings', 'autoHostReward', 50),
        hostMinViewerCount = $.getSetIniDbNumber('settings', 'hostMinViewerCount', 1),
        ...
        hostToggle = $.getSetIniDbBoolean('settings', 'hostToggle', true),
        autoHostToggle = $.getSetIniDbBoolean('settings', 'autoHostToggle', true),
    ...
    $.bind('twitchAutoHosted', function(event) {
        ...
        /*
        * This is the beginning of custom tags code.
        */
