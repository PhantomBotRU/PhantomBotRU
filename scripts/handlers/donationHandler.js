...
(function() {
    var announceDonations = $.getSetIniDbBoolean('donations', 'announce', true),
        donationReward = $.getSetIniDbFloat('donations', 'reward', 5),
        donationMessage = $.getSetIniDbString('donations', 'message', $.lang.get('donationhandler.donation.new')),
        donationGroup = $.getSetIniDbBoolean('donations', 'donationGroup', true),
    ...
    $.bind('streamLabsDonation', function(event) {
        ...
        if (announceDonations && announceDonationsAllowed) {
            ...
            */
        	...
        	if (donationSay.match('\n')) {
            	var splitMessage = donationSay.split('\n');
