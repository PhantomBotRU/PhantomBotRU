...
(function() {
    var message = $.getSetIniDbString('tipeeeStreamHandler', 'message', $.lang.get('tipeeestream.donation.new')),
        toggle = $.getSetIniDbBoolean('tipeeeStreamHandler', 'toggle', true),
        reward = $.getSetIniDbFloat('tipeeeStreamHandler', 'reward', 5),
        group = $.getSetIniDbBoolean('tipeeeStreamHandler', 'group', true),
