...
$.lang.register('tipeeestream.donation.new', '(name) подарил(а) (amount) (currency) через TipeeeStream'); // Дополнительные теги: (currency), (points) и (pointname)
$.lang.register('tipeeestream.donation.newreward', '(name) подарил(а) (amount) (currency) через TipeeeStream'); // Дополнительные теги: (currency), (points) и (pointname)
$.lang.register('tipeeestream.donations.usage', 'Применение: !tipeeestream (announce / rewardmultiplier n.n / message / lastmessage)');
...
$.lang.register('tipeeestream.donations.reward.usage', 'Применение: !tipeeestream rewardmultiplier [n.n]. Set to 0 to disable');
...
$.lang.register('tipeeestream.donations.message.usage', 'Применение: !tipeeestream message [message] Tags: (name) (amount) (currency) (currencysymbol) (message)');
$.lang.register('tipeeestream.donations.rewardmessage.usage', 'Применение: !tipeeestream rewardmessage [message] Tags: (name) (amount) (currency) (reward) (message)');
...
$.lang.register('tipeeestream.donators.min.usage', 'Применение: !tipeeestream minmumbeforepromotion (amount)');
