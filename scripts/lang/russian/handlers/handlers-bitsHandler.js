...
$.lang.register('bitshandler.message.usage', 'Применение: !bitsmessage (message) - Tags: (name), (amount), (reward)');
$.lang.register('bitshandler.message.set', 'Bits message has been set to: $1.');
$.lang.register('bitshandler.reward.usage', 'Применение: !bitsreward (amount)');
$.lang.register('bitshandler.reward.set', 'Bits reward has been set to: $1.');
$.lang.register('bitshandler.minimum.usage', 'Применение: !bitsminimum (amount)');
