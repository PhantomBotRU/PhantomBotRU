...
$.lang.register('discord.gambling.usage', 'Применение: !gamble [amount]');
$.lang.register('discord.gambling.set.max.usage', 'Применение: !gambling setmax [amount]');
$.lang.register('discord.gambling.set.max', 'Set max gambling to $1!');
$.lang.register('discord.gambling.set.min.usage', 'Применение: !gambling setmin [amount]');
$.lang.register('discord.gambling.set.min', 'Set minimum gambling to $1!');
$.lang.register('discord.gambling.win.range.usage', 'Применение: !gambling setwinningrange [range]');
$.lang.register('discord.gambling.win.range', 'Set gambling win range to $1-100 lose range to 1-$2');
$.lang.register('discord.gambling.percent.usage', 'Применение: !gambling setgainpercent [amount]');
$.lang.register('discord.gambling.percent', 'Set gambling gain percent to $1%');
$.lang.register('discord.gambling.main.usage', 'Применение: !gambling [setmax / setmin / setwinningrange / setgainpercent]');
