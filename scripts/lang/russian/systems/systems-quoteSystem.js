...
$.lang.register('quotesystem.add.usage1', 'Применение: !addquote [цитата]');
$.lang.register('quotesystem.add.usage2', 'Применение: !addquote [пользователь] [цитата]');
...
$.lang.register('quotesystem.del.usage', 'Применение: !delquote [quote id]');
...
$.lang.register('quotesystem.get.success', 'Цитата №(id): «(quote)» (добавлено пользователем (user) (date))'); // Tags = (id) (quote) (user) (game) (date) //
$.lang.register('quotesystem.get.404', 'Could not find quote $1… Are you sure it exists?');
$.lang.register('quotesystem.edit.usage', 'Применение: !editquote [quote id] [user / game / quote] текст]');
...
$.lang.register('quotesystem.quotemessage.usage', 'Применение: !quotemessage [message] (Tags: (id) (quote) (user) (game) (date))');
$.lang.register('quotesystem.quotemessage.success', 'Changed the message used for quotes');
$.lang.register('quotesystem.searchquote.usage', 'Применение: !searchquote [text] (Must provide at least 5 characters)');
