...
$.lang.register('noticehandler.notice-usage', 'Применение: !notice [add / get / remove / edit / config / interval / req / toggle / toggleoffline]');
$.lang.register('noticehandler.notice-get-usage', 'Применение: !notice get (notice id) - Notice id\'s go from 0 to $1');
$.lang.register('noticehandler.notice-error-notice-404', 'That notice does not exist.');
$.lang.register('noticehandler.notice-edit-usage', 'Применение: !notice edit (notice id) (message) - Notice id\'s go from 0 to $1');
$.lang.register('noticehandler.notice-remove-usage', 'Применение: !notice remove (notice id) - Notice id\'s go from 0 to $1');
...
$.lang.register('noticehandler.notice-add-usage', 'Применение: !notice add (message)');
$.lang.register('noticehandler.notice-interval-usage', 'Применение: !notice interval (interval)');
...
$.lang.register('noticehandler.notice-req-usage', 'Применение: !notice req (req messages)');
