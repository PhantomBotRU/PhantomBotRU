...
$.lang.register('slotmachine.rewards.usage', 'Применение: !slot rewards [val1] [val2] [val3] [val4] [val5]. Currently: $1');
$.lang.register('slotmachine.rewards.success', 'Updated rewards for the slot machine.');
$.lang.register('slotmachine.emote.usage', 'Применение: !slot emotes [emote1] [emote2] [emote3] [emote4] [emote5]. Currently: $1');
