...
$.lang.register('gambling.usage', 'Применение: !gamble [amount]');
$.lang.register('gambling.set.max.usage', 'Применение: !gamblesetmax [amount]');
$.lang.register('gambling.set.max', 'Set the maximum gambling amount to $1!');
$.lang.register('gambling.set.min.usage', 'Применение: !gamblesetmin [amount]');
$.lang.register('gambling.set.min', 'Set minimum gambling to $1!');
$.lang.register('gambling.win.range.usage', 'Применение: !gamblesetwinningrange [range]');
$.lang.register('gambling.win.range', 'Set gambling win range to $1-100 lose range to 1-$2');
$.lang.register('gambling.percent.usage', 'Применение: !gamblesetgainpercent [amount]');
