...
(function() {
    var patterns = {
        ...
        repeatedSeq: /(.)(\1+)/ig,
        nonAlphaSeq: /([^0-9a-zа-яёα-ϖ ])(\1+)/ig,
        nonAlphaCount: /([^0-9a-zа-яёα-ϖ ])/ig,
        capsCount: /([A-ZА-ЯЁΑ-Ω])/g,
        meCheck: /(^\/me)/i,
        fakePurge: new RegExp(/(^<[mмμ][eеε]ss[aаα]g[eеε]\s+d[eеε][liι][eеε][tтτ][eеε]d\.?>$)|(^<[сc][оoο][оoο]бщ[еeε][нhη][иu][еeε]\s+[уy]д[аaα][лλ][еeε][нhη][оoο]\.?>$)/i)
    };
