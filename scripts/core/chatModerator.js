...
(function() {
    var permitList = [],
        ...
        linksMessage = $.getSetIniDbString('chatModerator', 'linksMessage', 'публикация ссылки без разрешения'),
        ...
        capsMessage = $.getSetIniDbString('chatModerator', 'capsMessage', 'злоупотребление капсом'),
        capsLimitPercent = $.getSetIniDbFloat('chatModerator', 'capsLimitPercent', 80),
        ...
        spamMessage = $.getSetIniDbString('chatModerator', 'spamMessage', 'спам повторяющихся символов'),
        spamLimit = $.getSetIniDbNumber('chatModerator', 'spamLimit', 15),

        symbolsToggle = $.getSetIniDbBoolean('chatModerator', 'symbolsToggle', false),
        symbolsMessage = $.getSetIniDbString('chatModerator', 'symbolsMessage', 'чрезмерное использование символов'),
        ...
        emotesMessage = $.getSetIniDbString('chatModerator', 'emotesMessage', 'чрезмерное использование смайлов'),
        ...
        longMessageMessage = $.getSetIniDbString('chatModerator', 'longMessageMessage', 'чересчур длинное сообщение'),
        ...
        colorsMessage = $.getSetIniDbString('chatModerator', 'colorsMessage', 'использование цветного текста'),

        spamTrackerToggle = $.getSetIniDbBoolean('chatModerator', 'spamTrackerToggle', false),
        spamTrackerMessage = $.getSetIniDbString('chatModerator', 'spamTrackerMessage', 'флуд'),
        ...
        blacklistTimeoutTime = $.getSetIniDbNumber('chatModerator', 'blacklistTimeoutTime', 60),
        blacklistMessage = $.getSetIniDbString('chatModerator', 'blacklistMessage', 'использование слова или фразы из чёрного списка'),
        blacklistMessageBan = $.getSetIniDbString('chatModerator', 'blacklistMessageBan', 'использование слова или фразы из чёрного списка'),

        fakePurgeToggle = $.getSetIniDbBoolean('chatModerator', 'fakePurgeToggle', false),
        fakePurgeMessage = $.getSetIniDbString('chatModerator', 'fakePurgeMessage', 'подлог удалённого сообщения'),
        ...
        silentTimeout = {
            ...
            LinkMessage: $.getSetIniDbString('chatModerator', 'silentLinkMessage', 'публикация ссылки без разрешения'),
            SpamMessage: $.getSetIniDbString('chatModerator', 'silentSpamMessage', 'спам повторяющихся символов'),
            CapMessage: $.getSetIniDbString('chatModerator', 'silentCapMessage', 'злоупотребление капсом'),
            SymbolMessage: $.getSetIniDbString('chatModerator', 'silentSymbolsMessage', 'чрезмерное использование символов'),
            ColorMessage: $.getSetIniDbString('chatModerator', 'silentColorMessage', 'использование цветного текста'),
            EmoteMessage: $.getSetIniDbString('chatModerator', 'silentEmoteMessage', 'чрезмерное использование смайлов'),
            LongMessage: $.getSetIniDbString('chatModerator', 'silentLongMessage', 'чересчур длинное сообщение'),
            BlacklistMessage: $.getSetIniDbString('chatModerator', 'silentBlacklistMessage', 'использование слова или фразы из чёрного списка'),
            SpamTrackerMessage: $.getSetIniDbString('chatModerator', 'silentSpamTrackerMessage', 'флуд'),
            FakePurgeMessage: $.getSetIniDbString('chatModerator', 'silentFakePurgeMessage', 'подлог удалённого сообщения'),
        },

        warningTime = {
            Links: $.getSetIniDbNumber('chatModerator', 'warningTimeLinks', 1),
            Caps: $.getSetIniDbNumber('chatModerator', 'warningTimeCaps', 1),
            Symbols: $.getSetIniDbNumber('chatModerator', 'warningTimeSymbols', 1),
            Spam: $.getSetIniDbNumber('chatModerator', 'warningTimeSpam', 1),
            Emotes: $.getSetIniDbNumber('chatModerator', 'warningTimeEmotes', 1),
            Colors: $.getSetIniDbNumber('chatModerator', 'warningTimeColors', 1),
            LongMsg: $.getSetIniDbNumber('chatModerator', 'warningTimeLongMsg', 1),
            SpamTracker: $.getSetIniDbNumber('chatModerator', 'warningTimeSpamTracker', 1),
            FakePurge: $.getSetIniDbNumber('chatModerator', 'warningTimeFakePurge', 1),
        },

        timeoutTime = {
            Links: $.getSetIniDbNumber('chatModerator', 'timeoutTimeLinks', 60),
            Caps: $.getSetIniDbNumber('chatModerator', 'timeoutTimeCaps', 60),
            Symbols: $.getSetIniDbNumber('chatModerator', 'timeoutTimeSymbols', 60),
            Spam: $.getSetIniDbNumber('chatModerator', 'timeoutTimeSpam', 60),
            Emotes: $.getSetIniDbNumber('chatModerator', 'timeoutTimeEmotes', 60),
            Colors: $.getSetIniDbNumber('chatModerator', 'timeoutTimeColors', 60),
            LongMsg: $.getSetIniDbNumber('chatModerator', 'timeoutTimeLongMsg', 60),
            SpamTracker: $.getSetIniDbNumber('chatModerator', 'timeoutTimeSpamTracker', 60),
            FakePurge: $.getSetIniDbNumber('chatModerator', 'timeoutTimeFakePurge', 60),
        },

        moderationLogs = $.getSetIniDbBoolean('chatModerator', 'moderationLogs', false),
        msgCooldownSec = $.getSetIniDbNumber('chatModerator', 'msgCooldownSecs', 30),
        warningResetTime = $.getSetIniDbNumber('chatModerator', 'warningResetTime', 30),
    ...
    function extraCommands(event) {
        ...
        if (command.equalsIgnoreCase('moderation') || command.equalsIgnoreCase('mod')) { // js can't handle anymore commands in the default function.
            ...
            if (action.equalsIgnoreCase('togglemoderationlogs')) {
                ...
                $.say($.whisperPrefix(sender) + $.lang.get('chatmoderator.moderation.logs', (moderationLogs === true ? $.lang.get('chatmoderator.moderation.enabled') : $.lang.get('chatmoderator.moderation.disabled'))));
            }
            ...
            if (action.equalsIgnoreCase('regulars')) {
                ...
                if (subAction.equalsIgnoreCase('links')) {
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.say($.whisperPrefix(sender) + (regulars.LongMsg ? $.lang.get('chatmoderator.regulars.long.msg.allowed') : $.lang.get('chatmoderator.regulars.long.msg.not.allowed')));
            ...
            if (action.equalsIgnoreCase('subscribers')) {
                ...
                if (subAction.equalsIgnoreCase('links')) {
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.say($.whisperPrefix(sender) + (subscribers.LongMsg ? $.lang.get('chatmoderator.subscribers.long.msg.allowed') : $.lang.get('chatmoderator.subscribers.long.msg.not.allowed')));
            ...
            if (action.equalsIgnoreCase('silenttimeout')) {
                ...
                if (subAction.equalsIgnoreCase('links')) {
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.say($.whisperPrefix(sender) + (silentTimeout.LongMsg ? $.lang.get('chatmoderator.silenttimeout.long.msg.true') : $.lang.get('chatmoderator.silenttimeout.long.msg.false')));
