...
(function() {
	...
	$.bind('twitchFollow', function(event) {
		addObjectToArray('panelData', 'data', 'Фолловинг', {
	...
	$.bind('twitchBits', function(event) {
		addObjectToArray('panelData', 'data', 'Биты', {
    ...
    $.bind('twitchAutoHosted', function(event) {
    	addObjectToArray('panelData', 'data', 'Автохост', {
    ...
    $.bind('twitchHosted', function(event) {
    	addObjectToArray('panelData', 'data', 'Хост', {
			'username': event.getHoster(),
			'viewers' : event.getUsers(),
			'date'    : $.systemTime(),
			'isAuto'  : false
    ...
    $.bind('twitchSubscriber', function(event) {
    	addObjectToArray('panelData', 'data', 'Подписка', {
    ...
    $.bind('twitchPrimeSubscriber', function(event) {
    	addObjectToArray('panelData', 'data', 'Прайм-подписка', {
			'username': event.getSubscriber(),
			'date'    : $.systemTime(),
			'isReSub' : false,
			'months'  : 0
    ...
    $.bind('twitchReSubscriber', function(event) {
    	addObjectToArray('panelData', 'data', 'Мультиподписка', {
    ...
    $.bind('twitchSubscriptionGift', function(event) {
    	addObjectToArray('panelData', 'data', 'Подписка&nbsp;в&nbsp;подарок', {
    ...
    $.bind('twitchRaid', function(event) {
    	addObjectToArray('panelData', 'data', 'Рейд', {
			'username' : event.getUsername(),
