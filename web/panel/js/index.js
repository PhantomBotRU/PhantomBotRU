...
$(function() {
    ...
    webSocket.onclose = function() {
        ...
        // Add error toast.
        toastr.error('Соединение с ботом разорвано', '', { timeOut: 0 });
    };
        ...
        try {
            ...
            if (message.authresult !== undefined) {
                if (message.authresult === 'false') {
                    ...
                    toastr.error('Не удалось подсоединиться к боту', '', { timeOut: 0 });
                } else {
                    ...
                    if (localStorage.getItem('phantombot_beta_warning') !== 'true') {
                        if (confirm('Данный веб-интерфейс находится в стадии разработки. ' +
                            'Возможны ошибки, некоторые вкладки пока отключены.')) {
