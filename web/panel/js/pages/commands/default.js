    ...
    socket.getDBTableValues('commands_get_all', 'permcom', function(results) {
        socket.getDBTableValues('custom_commands_get_all', 'command', function(customCommands) {
            ...
            for (let i = 0; i < results.length; i++) {
                ...
                tableData.push([
                    ...
                    $('<div/>', {
                        ...
                        'style': 'float: right',
                        'data-toggle': 'tooltip',
                        'title': 'Сбросить уровень доступа команды до состояния по умолчанию (восстанавливается после рестарта бота)',
            ...
            table.on('click', '.btn-danger', function() {
                ...
                helpers.getConfirmDeleteModal('default_command_modal_remove', 'Вы уверены, что хотите сбросить уровень доступа команды «!' + command + '» до состояния по умолчанию?', false,
                        'Уровень доступа команды «!' + command + '» успешно сброшен', function() {
