...
$(function() {
        ...
        switch (false) {
            ...
            default:
                ...
                socket.updateDBValue('points_update_user', 'points', username.val().toLowerCase(), points.val(), function() {
                    // Alert the user.
                    toastr.success('Счёт пользователя ' + username.val() + ' успешно обновлён');
        ...
        switch (false) {
            ...
            default:
                ...
                socket.sendCommand('set_penalty_user', 'penalty ' + username.val().toLowerCase() + ' ' + time.val(), function() {
                    // Alert the user.
                    toastr.success('Штрафная санкция к пользователю ' + username.val() + ' успешно применена');
        ...
        switch (false) {
            ...
            default:
                ...
                socket.sendCommand('set_bonus_all', 'pointsbonuspanel ' + amount.val() + ' ' + time.val(), function() {
                    // Alert the user.
                    toastr.success('Размер бонуса успешно установлен');
        ...
        switch (false) {
            ...
            default:
                ...
                socket.sendCommand('main_it_rain_all', 'makeitrain ' + amount.val(), function() {
                    // Alert the user.
                    toastr.success('Указанное количество поинтов успешно роздано');
        ...
        switch (false) {
            ...
            default:
                ...
                socket.sendCommand('set_give_all', 'pointsallpanel ' + amount.val(), function() {
                    // Alert the user.
                    toastr.success('Указанное количество поинтов успешно передано каждому зрителю');
        ...
        switch (false) {
            ...
            default:
                ...
                socket.sendCommand('set_give_all', 'pointstakepanel ' + amount.val(), function() {
                    // Alert the user.
                    toastr.success('Указанное количество поинтов успешно отнято у каждого зрителя');
    ...
    $('#currency-reload').on('click', function() {
        // Reload all.
        run();
        toastr.success('Топ-100 обладателей поинтов успешно обновлён');
    });
                ...
                default:
                    ...
                    socket.updateDBValues('update_points_settings', {
                        ...
                        socket.sendCommand('update_points_settings_cmd', 'reloadpoints', function() {
                            toastr.success('Настройки вознаграждений успешно обновлены');
                        });
                    });
            }
        } else {
